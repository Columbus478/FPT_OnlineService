    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            if (loginInfo.Login.LoginProvider == "Google")
            {
                ...
                var mailClaim = externalIdentity.Result.Claims.FirstOrDefault(c => c.Type == ClaimTypes.Email);

                FullName = lastNameClaim.Value;
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        {
                            result1 = await UserManager.AddLoginAsync(Appuser.Id, info.Login);
                            if (result1.Succeeded)
                            {
